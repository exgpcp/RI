...
l2_dist= sum((intensity1 - lambda_xxx)^2)
...
time<- time.taken
coverage = mean(intensity1 >= low95 & intensity1 <= high95)
width = mean(high95 - low95)

outfile <- paste0("/home/groups/juliapr/Bingjing/code/currentcode/KS/syn1data_",
                  args[1],
                  ".rda")
