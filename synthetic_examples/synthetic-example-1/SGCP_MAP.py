...
np.savez('/output/simulation/adam1_1/syn1_priormle_'+sys.argv[1]+'.npz', aaa=M_list,aa=g_mk_list2,a=g_mk_list,c=points_inhomo,d=xxx,
...
import pickle
with open("/output/simulation/adam1_1/syn1_priormle1_"+sys.argv[1]+".bin", "wb") as output:
    pickle.dump(g_mk_list, output)

#with open("/output/nut/plot/AdamMH.bin", "rb") as data:
#    g_mk_list = pickle.load(data)

with open("/output/simulation/adam1_1/syn1_priormle2_"+sys.argv[1]+".bin", "wb") as output:
