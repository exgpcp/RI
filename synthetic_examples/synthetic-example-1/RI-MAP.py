...
np.savez('/output/simulation/mymethodfinal3/ESSsyn1_priormle'+sys.argv[1]+'.npz', aaa=g_mk_list3,aa=g_mk_list2,a=g_mk_list,c=points_inhomo,d=xxx,b=x,e=intensity,g=theta0,h=theta1,i=noise_var,m=integral_truth,n=integral_mean,o=integral_sd,q=timerun2)
