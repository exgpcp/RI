...
hyperpara=(pyreadr.read_r('/scratch/groups/juliapr/output_Bingjing/groundhypest.rda')["groundhypest"]).squeeze()
...
np.savez('/scratch/groups/juliapr/output_Bingjing/simulation/adam1_1/syn2_truthmle_'+sys.argv[1]+'.npz', aaa=M_list,aa=g_mk_list2,a=g_mk_list,c=points_inhomo,d=xxx,
...
import pickle
with open("/scratch/groups/juliapr/output_Bingjing/simulation/adam1_1/syn2_truthmle1_"+sys.argv[1]+".bin", "wb") as output:
...
with open("/scratch/groups/juliapr/output_Bingjing/simulation/adam1_1/syn2_truthmle2_"+sys.argv[1]+".bin", "wb") as output:
