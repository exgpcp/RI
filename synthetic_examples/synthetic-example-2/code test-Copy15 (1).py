...
for jjj in range(300):
    print(jjj)
    data = np.load('/scratch/groups/juliapr/output_Bingjing/simulation/mymethodfinal3/ESSsyn1_priormle'+str(jjj+1)+'.npz')
...
for jjj in range(300):
    print(jjj)
    data = np.load('/scratch/groups/juliapr/output_Bingjing/simulation/mymethodfinal3/ESSsyn2_priormle'+str(jjj+301)+'.npz')
    c=math.ceil((jjj+1)/100)
    g_mk_list3=data['a']
    g_mk_list3=data['aaa']
    g_mk_list2=data['aa']
