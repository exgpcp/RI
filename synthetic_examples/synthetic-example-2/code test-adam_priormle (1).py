...
for jjj in range(100):
    print(jjj)
    data = np.load('/scratch/groups/juliapr/output_Bingjing/simulation/adam1_1/priormle/syn1/syn1_priormle_'+str(jjj+1)+'.npz')
...
for jjj in range(100):
    print(jjj)
    data = np.load('/scratch/groups/juliapr/output_Bingjing/simulation/adam1_1/priormle/syn2/syn2_priormle_'+str(jjj+301)+'.npz')
    c=math.ceil((jjj+1)/100)
